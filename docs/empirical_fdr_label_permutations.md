...
![Empirical FDR curve and tau selection](docs/figures/fig2_fdr_curve.svg)
...
![All 35 label permutations for forest soil](docs/figures/fig1_permutation_enumeration.svg)
...
![How sample size sets the empirical FDR floor](docs/figures/fig3_sample_size_floor.svg)
